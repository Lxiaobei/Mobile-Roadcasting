!
    function (n) {
        n.fn.swipeslider = function (i) {
            ...
            function s(n) {
                2 == H && (H = 0, z = N > j ? z + 1 : z - 1, z = Math.min(Math.max(z, 0), Q - 1), j = z * -q, u(), p(), a()),
                    H = 0
            }
            function u() {
                A = !1,
            ...
            return function () {
                n(D).css("padding-top", F.sliderHeight),
                    ...
                    b(F.timingFunction),
                    X("all"),
                    I && (B.on("mousedown touchstart", e), n("html").on("mouseup touchend", s), n("html").on("mousemove touchmove", o)),
                    h(1),
                    a()
            }(),
                D
